...
namespace Net.Data.SAPBusinessOne
{
    ...
    public class OSKCRepository : RepositoryBase<OSKCEntity>, IOSKCRepository
    {
        ...
        public OSKCRepository(IConnectionSQL context, IConfiguration configuration, DataContextSAPBusinessOne db, IMapper am, CompanyProviderSAPBusinessOne companyProviderSap)
            : base(context)
        {
            _am = am;
            _dc = db;
