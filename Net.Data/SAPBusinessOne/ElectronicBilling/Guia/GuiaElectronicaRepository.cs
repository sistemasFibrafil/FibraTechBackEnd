...
{
    public class GuiaElectronicaRepository : RepositoryBase<GuiaElectronicaSapEntity>, IGuiaElectronicaRepository
    {
        ...
        public GuiaElectronicaRepository(IConnectionSQL context, IConfiguration configuration)
            : base(context)
        {
