...
{
    public class SubGrupoArticuloRepository : RepositoryBase<SubGrupoArticuloEntity>, ISubGrupoArticuloRepository
    {
        ...
        public SubGrupoArticuloRepository(IConnectionSQL context, DataContextSAPBusinessOne dc)
            : base(context)
        {
            _dc = dc;
