...
namespace Net.Data.SAPBusinessOne
{
    public class TipoLaminadoRepository : RepositoryBase<TipoLaminadoEntity>, ITipoLaminadoRepository
    {
        ...
        public TipoLaminadoRepository(IConnectionSQL context, DataContextSAPBusinessOne db)
            : base(context)
        {
            _db = db;
        }

        public async Task<ResultadoTransaccionResponse<TipoLaminadoEntity>> GetList()
        {
            var resultTransaccion = new ResultadoTransaccionResponse<TipoLaminadoEntity>();
        ...
        public async Task<ResultadoTransaccionResponse<TipoLaminadoEntity>> GetListByFiltro(TipoLaminadoEntity value)
        {
            var resultTransaccion = new ResultadoTransaccionResponse<TipoLaminadoEntity>();
