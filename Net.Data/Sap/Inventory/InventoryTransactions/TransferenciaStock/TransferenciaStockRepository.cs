...
{
    public class TransferenciaStockRepository : RepositoryBase<TransferenciaStockEntity>, ITransferenciaStockRepository
    {
        ...
        public TransferenciaStockRepository(IConnectionSQL context, IConfiguration configuration, DataContextSap db, IMapper mapper, CompanyProviderSap companyProviderSap)
            : base(context)
        {
            _db = db;
            _mapper = mapper;
        ...
        public async Task<ResultadoTransaccionEntity<TransferenciaStockQueryEntity>> GetListByFilter(TransferenciaStockFilterEntity value)
        {
            ...
            try
            {
                var query = _db.TransferenciaStock
                .AsNoTracking()
        ...
        public async Task<ResultadoTransaccionEntity<TransferenciaStockQueryEntity>> GetByDocEntry(int docEntry)
        {
            ...
            try
            {
                var data = await _db.TransferenciaStock
        ...
        public async Task<ResultadoTransaccionEntity<TransferenciaStockEntity>> SetCreate(TransferenciaStockCreateEntity value)
        {
            ...
            return await Task.Run(() =>
            {
                try
                {
                    ...
                    // SUNAT
                    // ===========================================================================================
                    if (value.U_BPP_MDTD != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDTD").Value = value.U_BPP_MDTD;
                    if (value.U_BPP_MDSD != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDSD").Value = value.U_BPP_MDSD;
                    //if (value.U_BPP_MDCD != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDCD").Value = value.U_BPP_MDCD;
                    // ALMACEN
                    // ===========================================================================================
                    ...
                    // TRANSPORTISTA
                    // ===========================================================================================
                    if (value.U_FIB_TIP_TRANS != null) stockTransfer.UserFields.Fields.Item("U_FIB_TIP_TRANS").Value = value.U_FIB_TIP_TRANS;
                    if (value.U_FIB_TIPDOC_TRA != null) stockTransfer.UserFields.Fields.Item("U_FIB_TIPDOC_TRA").Value = value.U_FIB_TIPDOC_TRA;
                    if (value.U_BPP_MDRT != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDRT").Value = value.U_BPP_MDRT;
                    if (value.U_BPP_MDNT != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDNT").Value = value.U_BPP_MDNT;
                    if (value.U_BPP_MDVC != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDVC").Value = value.U_BPP_MDVC;
                    // ===========================================================================================
                    // OTROS
                    // ===========================================================================================
                    if (value.U_FIB_TIPDOC_COND != null) stockTransfer.UserFields.Fields.Item("U_FIB_TIPDOC_COND").Value = value.U_FIB_TIPDOC_COND;
                    if (value.U_FIB_NUMDOC_COD != null) stockTransfer.UserFields.Fields.Item("U_FIB_NUMDOC_COD").Value = value.U_FIB_NUMDOC_COD;
                    if (value.U_FIB_NOM_COND != null) stockTransfer.UserFields.Fields.Item("U_FIB_NOM_COND").Value = value.U_FIB_NOM_COND;
                    if (value.U_FIB_APE_COND != null) stockTransfer.UserFields.Fields.Item("U_FIB_APE_COND").Value = value.U_FIB_APE_COND;
                    if (value.U_BPP_MDFN != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDFN").Value = value.U_BPP_MDFN;
                    if (value.U_BPP_MDFC != null) stockTransfer.UserFields.Fields.Item("U_BPP_MDFC").Value = value.U_BPP_MDFC;
                    // ===========================================================================================
                    // OTROS
                    // ===========================================================================================
                    ...
                    stockTransfer.UserFields.Fields.Item("U_FIB_FromPkg").Value = value.PickingLines.Count == 0 ? "N" : "Y";
                    stockTransfer.UserFields.Fields.Item("U_FIB_NBULTOS").Value = Convert.ToDouble(Math.Round(Convert.ToDecimal(value.U_FIB_NBULTOS ?? 0), 6));
                    stockTransfer.UserFields.Fields.Item("U_FIB_KG").Value = Convert.ToDouble(Math.Round(Convert.ToDecimal(value.U_FIB_KG ?? 0), 6));
                    ...
                    var serieDocumento = _db.NumeracionDocumentoSunat
                    ...
                    {
                        stockTransfer.Lines.BaseType = InvBaseDocTypeEnum.InventoryTransferRequest;
                        if (line.BaseEntry != null) stockTransfer.Lines.BaseEntry = (int)line.BaseEntry;
                        if (line.BaseEntry != null) stockTransfer.Lines.BaseLine = (int)line.BaseLine;
                        ...
                        stockTransfer.Lines.UserFields.Fields.Item("U_FIB_FromPkg").Value = line.U_FIB_FromPkg == "" ? "N" : line.U_FIB_FromPkg ?? "N";
                        if (line.U_tipoOpT12 != null || line.U_tipoOpT12 == "") stockTransfer.Lines.UserFields.Fields.Item("U_tipoOpT12").Value = line.U_tipoOpT12;
                        stockTransfer.Lines.UserFields.Fields.Item("U_FIB_NBulto").Value = Convert.ToDouble(Math.Round(Convert.ToDecimal(line.U_FIB_NBulto ?? 0), 6));
                        stockTransfer.Lines.UserFields.Fields.Item("U_FIB_PesoKg").Value = Convert.ToDouble(Math.Round(Convert.ToDecimal(line.U_FIB_PesoKg ?? 0), 6));
                    ...
                    if (reg == 0)
                    {
                        ...
                        if (value.PickingLines.Count > 0)
                        {
                            ...
                            if (!stockTransfer.GetByKey(docEntry)) throw new Exception("No existe la solictud de transferencia.");


                            //// Se valida que la transferencia de stock tenga líneas en el detalle
                            ...
                            {
                                // Se recorre las líneas de la transferencia de stock
        ...
        public async Task<ResultadoTransaccionEntity<TransferenciaStockEntity>> SetUpdate(TransferenciaStockUpdateEntity value)
        {
            var resultTransaccion = new ResultadoTransaccionEntity<TransferenciaStockEntity>
            {
                NombreMetodo = regex.Match(System.Reflection.MethodBase.GetCurrentMethod().DeclaringType.Name).Groups[1].Value,
        ...
        {
            var header = new TransferenciaStockFormatoEntity();
            var linea = new List<TransferenciaStock1FormatoEntity>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_TRANSFERENCIASTOCK_BY_DOCENTRY, conn))
                    {
                        ...
                        {
                            header = context.Convert<TransferenciaStockFormatoEntity>(reader);
                        }
                    }
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_LIST_TRANSFERENCIASTOCK_DETALLE_BY_DOCENTRY, conn))
                    {
                        ...
                        using (var reader = await cmd.ExecuteReaderAsync())
                        {
                            linea = (List<TransferenciaStock1FormatoEntity>)context.ConvertTo<TransferenciaStock1FormatoEntity>(reader);
                        }
                    }
