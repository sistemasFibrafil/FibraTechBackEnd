...
namespace Net.Data.Sap
{
    public class TakeInventorySparePartsRepository : RepositoryBase<TakeInventorySparePartsEntity>, ITakeInventorySparePartsRepository
    {
        ...
        public TakeInventorySparePartsRepository(IConnectionSQL context, IConfiguration configuration, DataContextSeg dbSeg, DataContextSap dbSap, CompanyProviderSap companyProviderSap)
           : base(context)
        {
            _dbSeg = dbSeg;
            _dbSap = dbSap;
        ...
        public async Task<ResultadoTransaccionEntity<TakeInventorySparePartsEntity>> GetListByFilter(TakeInventorySparePartsFilterEntity value)
        {
            ...
            try
            {
                var query =_dbSap.TakeInventorySpares
                .AsNoTracking()
        ...
        public async Task<ResultadoTransaccionEntity<MemoryStream>> GetExcelByFilter(TakeInventorySparePartsFilterEntity value)
        {
            ...
            try
            {
                using (SpreadsheetDocument document = SpreadsheetDocument.Create(ms, SpreadsheetDocumentType.Workbook))
                {
                    ...
                    var query =
                    from n in _dbSap.TakeInventorySpares
        ...
        public async Task<ResultadoTransaccionEntity<TakeInventorySparePartsEntity>> SetCreate(TakeInventorySparePartsCreateEntity value)
        {
            ...
            try
            {
                ...
                var cantidadPicking = await _dbSap.TakeInventorySpares.CountAsync(n => n.U_IsDelete == "N" && n.U_ItemCode == value.U_CodeBar && n.U_WhsCode == value.U_WhsCode && n.U_UsrCreate == value.U_UsrCreate && n.U_CreateDate == value.U_CreateDate);
                ...
                var list = await _dbSap.TakeInventorySpares
                .Where(n => n.U_IsDelete == "N" && n.U_WhsCode == value.U_WhsCode && n.U_UsrCreate == value.U_UsrCreate && n.U_CreateDate == value.U_CreateDate)
