...
namespace Net.Data.Sap
{
    public class DireccionSapRepository : RepositoryBase<DireccionSapEntity>, IDireccionSapRepository
    {
        ...
        const string SP_GET_LIST_BY_CARDCODE = DB_ESQUEMA + "SOC_GetListDireccionByFiltro";
        const string SP_GET_BY_CODE = DB_ESQUEMA + "SOC_GetDireccionByCode";
        ...
        public async Task<ResultadoTransaccionEntity<DireccionSapEntity>> GetListByFiltro(FilterRequestEntity value)
        {
            var response = new List<DireccionSapEntity>();
            var resultTransaccion = new ResultadoTransaccionEntity<DireccionSapEntity>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_LIST_BY_CARDCODE, conn))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@AdresType", value.Cod2));
        ...
        public async Task<ResultadoTransaccionEntity<DireccionSapEntity>> GetByCode(FilterRequestEntity value)
        {
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_BY_CODE, conn))
                    {
                        ...
                        cmd.CommandTimeout = 0;
                        cmd.Parameters.Add(new SqlParameter("@CardCode", value.Cod1));
                        cmd.Parameters.Add(new SqlParameter("@AdresType", value.Cod3));
                        cmd.Parameters.Add(new SqlParameter("@Address", value.Cod2));
