...
namespace Net.Data.Sap
{
    public class MonedaSapRepository : RepositoryBase<MonedaSapEntity>, IMonedaSapRepository
    {
        ...
        const string SP_GET_LIST_BY_FILTRO = DB_ESQUEMA + "GES_GetListMonedaByFiltro";
        const string SP_GET_BY_SLPCODE = DB_ESQUEMA + "GES_GetMonedaByCode";
        ...
        public async Task<ResultadoTransaccionEntity<MonedaSapEntity>> GetListByFiltro(FilterRequestEntity value)
        {
            var response = new List<MonedaSapEntity>();
            var resultTransaccion = new ResultadoTransaccionEntity<MonedaSapEntity>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_LIST_BY_FILTRO, conn))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@CurrCode", value.Cod1));
        ...
        public async Task<ResultadoTransaccionEntity<MonedaSapEntity>> GetByCode(FilterRequestEntity value)
        {
