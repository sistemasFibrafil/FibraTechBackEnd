...
namespace Net.Data.Sap
{
    public class ConductorSapRepository : RepositoryBase<ConductorSapEntity>, IConductorSapRepository
    {
        ...
        const string SP_GET_LIST_BY_FILTRO = DB_ESQUEMA + "GES_GetListConductorByFiltro";
        ...
        public async Task<ResultadoTransaccionEntity<ConductorSapEntity>> GetListByFiltro(FilterRequestEntity value)
        {
            var response = new List<ConductorSapEntity>();
            var resultadoTran = new ResultadoTransaccionEntity<ConductorSapEntity>();
            ...
            try
            {
                using (SqlConnection conn = new SqlConnection(_cnxSap))
                {
                    ...
                    using (SqlCommand cmd = new SqlCommand(SP_GET_LIST_BY_FILTRO, conn))
                    {
                        ...
                        cmd.Parameters.Add(new SqlParameter("@NomConductor", value.Text1));
