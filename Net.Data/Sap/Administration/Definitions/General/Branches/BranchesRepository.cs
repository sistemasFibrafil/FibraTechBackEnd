...
namespace Net.Data.Sap
{
    public class BranchesRepository : RepositoryBase<BranchesEntity>, IBranchesRepository
    {
        ...
        public BranchesRepository(IConnectionSQL context, DataContextSap db)
            : base(context)
        {
            _db = db;
        }
        ...
        public async Task<ResultadoTransaccionEntity<BranchesEntity>> GetList()
        {
            var resultTransaccion = new ResultadoTransaccionEntity<BranchesEntity>
            {
