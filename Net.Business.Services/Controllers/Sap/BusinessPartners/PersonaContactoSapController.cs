...
namespace Net.Business.Services.Controllers.Sap.BusinessPartners
{
    ...
    public class PersonaContactoSapController : ControllerBase
    {
        ...
        {
            var objectGetList = await _repository.PersonaContacto.GetListByFiltro(value.ReturnValue());
        ...
        {
            var objectGet = await _repository.PersonaContacto.GetById(value.ReturnValue());
