...
namespace Net.Business.Services.Controllers.Sap.SociosNegocios
{
    ...
    public class DireccionSapController : Controller
    {
        ...
        {
            var objectGetList = await _repository.DireccionSap.GetListByFiltro(value.ReturnValue());
        ...
        {
            var objectGet = await _repository.DireccionSap.GetByCode(value.ReturnValue());
