...
namespace Net.Business.Services.Controllers.Sap.Ventas
{
    ...
    public class EntregaSapController : Controller
    {
        ...
        public async Task<IActionResult> GetListGuiaByFecha([FromQuery] FilterRequestDto value)
        {
            var objectGetList = await _repository.EntregaSap.GetListGuiaByFecha(value.ReturnValue());
        ...
        public async Task<IActionResult> GetGuiaExcelByFecha([FromQuery] FilterRequestDto value)
        {
            try
            {
                var objectGetAll = await _repository.EntregaSap.GetGuiaExcelByFecha(value.ReturnValue());
