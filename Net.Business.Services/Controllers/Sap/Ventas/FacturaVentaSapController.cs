...
namespace Net.Business.Services.Controllers.Sap.Ventas
{
    ...
    public class FacturaVentaSapController : Controller
    {
        ...
        {
            var objectGetAll = await _repository.FacturaVentaSap.GetListVentaByFilter(value.ReturnValue());
        ...
        public async Task<IActionResult> GetVentaByFilterExcel([FromQuery] VentaSapByFilterFindDto value)
        {
            try
            {
                var objectGetAll = await _repository.FacturaVentaSap.GetVentaByFilterExcel(value.ReturnValue());
        ...
        {
            var objectGetAll = await _repository.FacturaVentaSap.GetListFacturaVentaByFilter(value.ReturnValue());
        ...
        public async Task<IActionResult> GetFacturaVentaByFilterExcel([FromQuery] FacturaVentaSapByFilterFindDto value)
        {
            try
            {
                var objectGetAll = await _repository.FacturaVentaSap.GetFacturaVentaByFilterExcel(value.ReturnValue());
