...
namespace Net.Business.Services.Controllers.SAPBusinessOne.Administration.Definitions.BusinessPartners
{
    ...
    public class BusinessPartnerSectorsController : ControllerBase
    {
        private readonly IRepositoryWrapper _repository;
        public BusinessPartnerSectorsController(IRepositoryWrapper repository)
        {
        ...
        {
            var objectGetList = await _repository.BusinessPartnerSectors.GetList();
