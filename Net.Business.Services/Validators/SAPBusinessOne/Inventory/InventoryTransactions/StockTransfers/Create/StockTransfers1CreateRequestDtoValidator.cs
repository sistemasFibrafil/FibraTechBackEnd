...
{
    public class StockTransfers1CreateRequestDtoValidator : AbstractValidator<StockTransfers1CreateRequestDto>
    {
        public StockTransfers1CreateRequestDtoValidator()
        {
