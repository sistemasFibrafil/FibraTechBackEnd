...
{
    public class InventoryTransferRequest1UpdateRequestDtoValidator : AbstractValidator<InventoryTransferRequest1UpdateRequestDto>
    {
        public InventoryTransferRequest1UpdateRequestDtoValidator()
        {
