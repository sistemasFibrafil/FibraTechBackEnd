...
namespace Net.Business.Entities.SAPBusinessOne.Drafts.CreateToDocument
{
    public class DraftsCreateToDocumentEntity
    {
        ...
        public Attachments2CreateToDocumentEntity? Attachments2 { get; set; } = null;
        public List<DraftsLinesCreateToDocumentEntity> Lines { get; set; } = [];
    }
}
