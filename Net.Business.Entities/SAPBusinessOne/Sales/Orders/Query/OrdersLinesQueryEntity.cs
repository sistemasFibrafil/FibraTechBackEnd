...
{
    public class OrdersLinesQueryEntity
    {
        ...
        public bool IsItemCodeValidated { get; set; } = true;
        public string? ValidatedItemCode { get; set; }

        public bool IsFormatCodeValidated { get; set; } = true;
        public string? ValidatedFormatCode { get; set; }

        public bool IsWhsCodeValidated { get; set; } = true;
        public string? ValidatedWhsCode { get; set; }

        public bool IsTaxCodeValidated { get; set; } = true;
        public string? ValidatedTaxCode { get; set; }

        public bool IsOperationTypeValidated { get; set; } = true;
        public string? ValidatedOperationType { get; set; }
    }
}
