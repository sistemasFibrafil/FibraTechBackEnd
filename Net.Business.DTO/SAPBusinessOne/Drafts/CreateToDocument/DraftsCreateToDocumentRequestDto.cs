...
{
    public class DraftsCreateToDocumentRequestDto
    {
        ...
        public Attachments2CreateToDocumentRequestDto? Attachments2 { get; set; }
        public List<DraftsLinesCreateToDocumentRequestDto> Lines { get; set; } = [];
    }
}
