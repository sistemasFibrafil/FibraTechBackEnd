...
namespace Net.Business.DTO.SAPBusinessOne
{
    public class BusinessPartnersCreateRequestDto
    {
        ...
        public List<BPAddressesCreateRequestDto>? Addresses { get; set; }
        public List<BPContactEmployeesCreateRequestDto>? ContactEmployees { get; set; }

        public BusinessPartnersCreateEntity ReturnValue()
        {
            var entity = new BusinessPartnersCreateEntity
            {
                CardCode = this.CardCode,
                CardName = this.CardName ?? string.Empty,
                CardType = this.CardType ?? "C",
                ...
                ValidFor = this.ValidFor ?? "Y",
                U_FIB_Email2 = this.U_FIB_Email2,
                U_FIB_Email3 = this.U_FIB_Email3,
                Addresses = new List<BPAddressesCreateEntity>(),
                ContactEmployees = new List<BPContactEmployeesCreateEntity>()
            };
            ...
            if (this.ContactEmployees != null)
            {
                ...
                {
                    entity.ContactEmployees.Add(new BPContactEmployeesCreateEntity
                    {
    ...
    public class BPAddressesCreateRequestDto
    {
    ...
    public class BPContactEmployeesCreateRequestDto
    {
