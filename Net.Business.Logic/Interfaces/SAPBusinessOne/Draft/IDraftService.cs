...
namespace Net.Business.Logic.Interfaces.SAPBusinessOne.Draft
{
    public interface IDraftService
    {
        Task<ResultadoTransaccionResponse<object>> SetCreate(DraftsCreateRequestDto dto, IList<IFormFile> files);
        Task<ResultadoTransaccionResponse<object>> SetSaveDraftToDocument(DraftsCreateToDocumentRequestDto dto, IList<IFormFile> files);
