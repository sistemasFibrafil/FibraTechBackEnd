...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Inventory.InventoryTransactions.InventoryTransferRequest.Update
{
    public class InventoryTransferRequestUpdateRequestDtoValidator : AbstractValidator<InventoryTransferRequestUpdateRequestDto>
    {
        public InventoryTransferRequestUpdateRequestDtoValidator()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new InventoryTransferRequestLinesUpdateRequestDtoValidator());
        }
    }
}
