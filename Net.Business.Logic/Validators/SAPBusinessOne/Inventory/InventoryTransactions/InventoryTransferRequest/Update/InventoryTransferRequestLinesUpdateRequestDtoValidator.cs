...
{
    public class InventoryTransferRequestLinesUpdateRequestDtoValidator : AbstractValidator<InventoryTransferRequestLinesUpdateRequestDto>
    {
        public InventoryTransferRequestLinesUpdateRequestDtoValidator()
        {
