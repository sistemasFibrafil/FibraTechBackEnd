...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Inventory.InventoryTransactions.InventoryTransferRequest.Create
{
    public class InventoryTransferRequestLinesCreateRequestDtoValidator : AbstractValidator<InventoryTransferRequestLinesCreateRequestDto>
    {
        public InventoryTransferRequestLinesCreateRequestDtoValidator()
        {
