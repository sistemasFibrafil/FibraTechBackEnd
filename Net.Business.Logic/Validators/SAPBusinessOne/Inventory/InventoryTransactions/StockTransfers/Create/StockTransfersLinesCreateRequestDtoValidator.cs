...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Inventory.InventoryTransactions.StockTransfers.Create
{
    public class StockTransfersLinesCreateRequestDtoValidator : AbstractValidator<StockTransfersLinesCreateRequestDto>
    {
        public StockTransfersLinesCreateRequestDtoValidator()
        {
