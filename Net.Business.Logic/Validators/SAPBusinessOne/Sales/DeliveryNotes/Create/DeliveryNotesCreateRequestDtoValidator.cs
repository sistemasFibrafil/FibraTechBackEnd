...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Sales.DeliveryNotes.Create
{
    public class DeliveryNotesCreateRequestDtoValidator : AbstractValidator<DeliveryNotesCreateRequestDto>
    {
        public DeliveryNotesCreateRequestDtoValidator()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            */
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new DeliveryNotes1CreateRequestDtoValidator());
        }
    }
}
