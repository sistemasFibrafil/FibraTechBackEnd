...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Sales.Orders.Create
{
    public class OrdersCreateRequestDtoValidator : AbstractValidator<OrdersCreateRequestDto>
    {
        public OrdersCreateRequestDtoValidator()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            */
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new OrdersLinesCreateRequestDtoValidator());
        }
    }
}
