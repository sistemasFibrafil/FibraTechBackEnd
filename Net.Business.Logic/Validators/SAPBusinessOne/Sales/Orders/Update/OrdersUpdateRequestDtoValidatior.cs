...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Sales.Orders.Update
{
    public class OrdersUpdateRequestDtoValidatior : AbstractValidator<OrdersUpdateRequestDto>
    {
        public OrdersUpdateRequestDtoValidatior()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            */
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new OrdersLinesUpdateRequestDtoValidator());
        }
    }
}
