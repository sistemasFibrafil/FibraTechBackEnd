...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Sales.Invoices.Create
{
    public class InvoicesCreateRequestDtoValidator : AbstractValidator<InvoicesCreateRequestDto>
    {
        public InvoicesCreateRequestDtoValidator()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            */
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new InvoicesLinesCreateRequestDtoValidator());
        }
    }
}
