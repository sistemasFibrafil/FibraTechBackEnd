...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Drafts.Update
{
    public class DraftsLinesUpdateRequestDtoValidator : AbstractValidator<DraftsLinesUpdateRequestDto>
    {
        public DraftsLinesUpdateRequestDtoValidator()
        {
