...
{
    public class DraftLinesCreateToDocumentRequestDtoValidator : AbstractValidator<DraftsLinesCreateToDocumentRequestDto>
    {
        public DraftLinesCreateToDocumentRequestDtoValidator()
        {
