...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Drafts.CreateToDocument
{
    public class DraftCreateToDocumentRequestDtoValidator : AbstractValidator<DraftsCreateToDocumentRequestDto>
    {
        public DraftCreateToDocumentRequestDtoValidator()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            */
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new DraftLinesCreateToDocumentRequestDtoValidator());
        }
    }
}
