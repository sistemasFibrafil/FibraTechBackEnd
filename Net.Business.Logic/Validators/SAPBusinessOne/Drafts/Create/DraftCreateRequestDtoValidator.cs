...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Draft.Create
{
    public class DraftCreateRequestDtoValidator : AbstractValidator<DraftsCreateRequestDto>
    {
        public DraftCreateRequestDtoValidator()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            */
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new DraftLinesCreateRequestDtoValidator());
        }
    }
}
