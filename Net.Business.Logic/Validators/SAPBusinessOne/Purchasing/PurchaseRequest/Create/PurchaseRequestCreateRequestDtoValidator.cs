...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Purchasing.PurchaseRequest.Create
{
    public class PurchaseRequestCreateRequestDtoValidator : AbstractValidator<PurchaseRequestCreateRequestDto>
    {
        public PurchaseRequestCreateRequestDtoValidator()
        {
            RuleFor(x => x.DocDate)
                .NotEmpty()
            ...
            */
            ...
            RuleForEach(x => x.Lines)
                .SetValidator(new PurchaseRequestLinesCreateRequestDtoValidator());
        }
    }
}
