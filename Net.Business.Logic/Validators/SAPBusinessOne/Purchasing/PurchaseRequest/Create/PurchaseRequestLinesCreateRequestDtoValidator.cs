...
{
    public class PurchaseRequestLinesCreateRequestDtoValidator : AbstractValidator<PurchaseRequestLinesCreateRequestDto>
    {
        public PurchaseRequestLinesCreateRequestDtoValidator()
        {
