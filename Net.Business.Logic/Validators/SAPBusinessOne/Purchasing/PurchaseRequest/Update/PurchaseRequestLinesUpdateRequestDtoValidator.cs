...
namespace Net.Business.Logic.Validators.SAPBusinessOne.Purchasing.PurchaseRequest.Update
{
    public class PurchaseRequestLinesUpdateRequestDtoValidator : AbstractValidator<PurchaseRequestLinesUpdateRequestDto>
    {
        public PurchaseRequestLinesUpdateRequestDtoValidator()
        {
