...
namespace Net.Business.Logic.Mappers.SAPBusinessOne.Sales.Orders.Create
{
    public class OrdersCreateMapper
    {
        public static OrdersCreateEntity ToEntity(OrdersCreateRequestDto dto)
        {
            return new OrdersCreateEntity
            {
                ...
                Lines = [.. dto.Lines.Select(l => new OrdersLinesCreateEntity
                {
                    ItemCode = l.ItemCode,
