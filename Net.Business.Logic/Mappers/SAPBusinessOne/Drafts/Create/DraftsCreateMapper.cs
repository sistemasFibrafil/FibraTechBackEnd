...
namespace Net.Business.Logic.Mappers.SAPBusinessOne.Draft.Create
{
    public class DraftsCreateMapper
    {
        public static DraftsCreateEntity ToEntity(DraftsCreateRequestDto dto)
        {
            return new DraftsCreateEntity
            {
                DocDate = dto.DocDate,
                ...
                // 🔥 FILES
                Attachments2 = dto.Attachments2 != null ? new Attachments2CreateEntity
                {
                    AbsEntry = dto.Attachments2.AbsEntry,
                    Lines = [..dto.Attachments2.Lines.Select(l => new Attachments2LinesCreateEntity
                    {
                        SrcPath = l.SrcPath,
                        TrgtPath = l.TrgtPath,
                        FileName = l.FileName,
                ...
                Lines = [.. dto.Lines.Select(l => new DraftsLinesCreateEntity
                {
                    ItemCode = l.ItemCode,
