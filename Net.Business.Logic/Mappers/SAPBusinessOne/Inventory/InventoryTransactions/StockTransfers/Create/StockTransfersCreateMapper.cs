...
namespace Net.Business.Logic.Mappers.SAPBusinessOne.Inventory.InventoryTransactions.StockTransfers.Create
{
    public class StockTransfersCreateMapper
    {
        public static StockTransfersCreateEntity ToEntity(StockTransfersCreateRequestDto dto)
        {
            return new StockTransfersCreateEntity
            {
                ...
                Lines = [.. dto.Lines.Select(l => new StockTransfersLinesCreateEntity
                {
