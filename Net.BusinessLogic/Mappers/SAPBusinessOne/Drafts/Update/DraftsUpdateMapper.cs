...
namespace Net.BusinessLogic.Mappers.SAPBusinessOne.Draft.Update
{
    public class DraftsUpdateMapper
    {
        public static DraftsUpdateEntity ToEntity(DraftsUpdateRequestDto dto)
        {
            return new DraftsUpdateEntity
            {
                ...
                Lines = [.. dto.Lines.Where(l => l.Record != 3).Select(l => new DraftsLinesUpdateEntity
                {
