...
{
    public class PurchaseRequest1CreateRequestDtoValidator : AbstractValidator<PurchaseRequest1CreateRequestDto>
    {
        public PurchaseRequest1CreateRequestDtoValidator()
        {
